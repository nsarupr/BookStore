...
public class AddInventoryResponse extends Response {
    ...
    public AddInventoryResponse(boolean success, ResponseStatus responseStatus, String error, String notes, Inventory inventory, InventoryLog inventoryLog) {
